        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan anda sudah sukses dicheck out, agar barang segera diproses harap lanjut menuju pembayaran. Silahkan lakukan transfer pada <strong>Bank BNI Nomer Rekening : 26374-172839-350</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong></h5>
                </div>
            </div>
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            @endforeach
                            <tr>
                                <td colspan="5" align="right"><strong>Kode Voucher :</strong></td>
